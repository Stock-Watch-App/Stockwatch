      ...
      >
        ...
        <tbody slot="body" slot-scope="{ displayData }">
          <tr v-for="leaderboard in displayData" :key="leaderboard.user_id">
            <td>
              <div class="rank-num" :class="leaderboard.rank.class">{{ leaderboard.rank.rank }}</div>
            </td>
            <td class="user-row">
              ...
              <span
                ...
                class="tag lfc"
              >LFC</span>
              <first-badge v-if="leaderboard.user.id === 4" class="leaderboard-badge"></first-badge>
              <second-badge v-if="leaderboard.user.id === 4" class="leaderboard-badge"></second-badge>
              <third-badge v-if="leaderboard.user.id === 4" class="leaderboard-badge"></third-badge>
              <topfive-badge v-if="leaderboard.user.id === 4" class="leaderboard-badge"></topfive-badge>
              <topten-badge v-if="leaderboard.user.id === 4" class="leaderboard-badge"></topten-badge>
            </td>
