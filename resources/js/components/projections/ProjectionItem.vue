  ...
  <div class="projection-card">
    ...
    <div class="next-week">
      ...
      <dl class="rating-table">
        ...
        >{{ Math.round((houseguest.projections.to1/houseguest.current_price-1)*100) }}%</dd>
        <dd
          :style="setbg(houseguest.projections.to2)"
        >{{ Math.round((houseguest.projections.to2/houseguest.current_price-1)*100) }}%</dd>
        <dd
          :style="setbg(houseguest.projections.to3)"
        >{{ Math.round((houseguest.projections.to3/houseguest.current_price-1)*100) }}%</dd>
        <dd
          :style="setbg(houseguest.projections.to4)"
        >{{ Math.round((houseguest.projections.to4/houseguest.current_price-1)*100) }}%</dd>
        <dd
          :style="setbg(houseguest.projections.to5)"
        >{{ Math.round((houseguest.projections.to5/houseguest.current_price-1)*100) }}%</dd>
        <dd
          :style="setbg(houseguest.projections.to6)"
        >{{ Math.round((houseguest.projections.to6/houseguest.current_price-1)*100) }}%</dd>
        <dd
          :style="setbg(houseguest.projections.to7)"
        >{{ Math.round((houseguest.projections.to7/houseguest.current_price-1)*100) }}%</dd>
        <dd
          :style="setbg(houseguest.projections.to8)"
        >{{ Math.round((houseguest.projections.to8/houseguest.current_price-1)*100) }}%</dd>
        <dd
          :style="setbg(houseguest.projections.to9)"
        >{{ Math.round((houseguest.projections.to9/houseguest.current_price-1)*100) }}%</dd>
        <dd
          :style="setbg(houseguest.projections.to10)"
        >{{ Math.round((houseguest.projections.to10/houseguest.current_price-1)*100) }}%</dd>
