...
library.add(faStar, faArrowUp, faArrowDown, faBars, faColumns, faTwitch, faTwitter, faDiscord, faFacebookF, faReddit, faAward, faHistory, faUserCircle, faUserShield, faSignOutAlt, faMinus, faPlus, faUndoAlt, faEye, faSpinner, faChartLine, faInfoCircle, faChevronDown, faMicrophone, faBug, faTrophy, faSignInAlt)
...
Vue.component('guest-trade-panel', require('./components/trades/Guest.vue').default);
